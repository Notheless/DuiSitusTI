function showInsertDiv() {
	...
	xmlhttp.open("GET","jeroan/d.doseninsert.php",true);
	xmlhttp.send();	
}
...
function showUpdateDiv(str) {
	...
	xmlhttp.open("GET","jeroan/d.dosenedit.php?ID="+str,true);
	xmlhttp.send();
}
...
function showDeleteDiv(str) {
	...
	xmlhttp.open("GET","jeroan/d.dosendelete.php?ID="+str,true);
	xmlhttp.send();
}
