    ...
    <div class="admin-content-pos">
        ...
        <div class="admin-main-content">
            <table>
                ...
                <tr>
                    <td>Prestasi Mahasiswa TI Unpad di 3rd International Conference on Science in Information Technology (ICSITech) 2017</td>
                    <td>11/05/2017</td>
                    <td><button id="update-button" type="button" onclick="showUpdateDiv()">edit</button><button id="delete-button" type="button" onclick="showDeleteDiv()">hapus</button></td>
                </tr>
            </table>
