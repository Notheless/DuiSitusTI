...
<body>
    ...
    <div class="grid-container">
		...
		<div class="grid-headline-header">
            <h1 class="headline-header"><span class="header-revcolor">KERJASAMA</span></h1>
        </div>
        <div class="grid-headline-para">
            <p class="headline-para">
                Program studi S1 Teknik Informatika Universitas Padjadjaran telah bekerjasama dengan berbagai lembaga untuk membangun sebuah hubungan harmonis dalam mencapai tujuan dan kebaikan bersama.
            </p>
        </div>
        <div class="grid-headline-thumbnail">
            <img style="thumbnail" src="f_img/17.jpg" height="100%px" width="100%"/>
        </div>
