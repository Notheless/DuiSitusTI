    ...
    <div class="grid-container">
        ...
        <div class="grid-headline-para">
            <p class="headline-para">
                Beikut adalah publikasi dari penelitan maupun seminar yang telah dilakukan oleh Dosen maupun mahasiswa Program Studi S1 FMIPA Universitas Padjadjaran.
            </p>
        </div>
        <div class="grid-headline-thumbnail">
            <img style="thumbnail" src="f_img/16.jpg" height="100%px" width="100%"/>
        </div>
